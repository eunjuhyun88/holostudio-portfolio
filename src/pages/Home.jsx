    ...
    const content = {
        en: {
            hero: {
                ...
                desc: "Creation costs have collapsed. Verification costs have exploded. We build the Trust Layer where safety, provenance, and value settlement are guaranteed by code.",
            ...
            market: {
                ...
                gap: { val: "$13B+", label: "Global Safety Infrastructure Gap" }
            },
            problem: {
                title: "The Core Problem",
                sub: "\"The slop generated by AI is breeding distrust.\" — Steve Hirsch\nTrust is no longer implicit. It must be engineered.",
                cards: [
                    { title: "Safety Crisis", desc: "Deepfakes and toxic media erode brand and platform integrity.", badge: "Safety Crisis" },
                    { title: "Provenance Void", desc: "Original creators disappear in infinite AI generation.", badge: "Provenance Void" },
                    { title: "Value Leakage", desc: "Platforms extract value. Creators, prompters, and verifiers are left out.", badge: "Value Leakage" }
                ]
            },
            thesis: {
