    ...
    const content = {
        en: {
            hero: {
                ...
                title: "HOLO STUDIO",
                sub: "Infinite Content. Finite Trust. We Engineer the Infrastructure of Certainty.",
                desc: "Creation costs have hit zero. Verification costs have skyrocketed. We build the Trust Layer where safety, provenance, and value are guaranteed by code.",
                cta1: "View Business Portfolio",
                cta2: "Partnership Inquiry"
            },
            market: {
                year: { val: "2025", label: "AI Safety Tipping Point" },
                eu: { val: "EU Act", label: "DSA & AI Act Enforcement" },
                size: { val: "$80B", label: "AI Content Market (2030)" },
                gap: { val: "$13B+", label: "Safety Infrastructure Gap" }
            },
            problem: {
                title: "The Core Problem",
                sub: "\"The 'slop' generated by AI is breeding distrust.\" — Steve Hirsch\nTrust is no longer default. It must be engineered.",
                cards: [
                    { title: "Safety Crisis", desc: "Deepfakes and toxic content threaten brands and platforms.", badge: "Safety Void" },
                    { title: "Provenance Void", desc: "Original creators are erased in the flood of AI generation.", badge: "No Proof" },
                    { title: "Value Leakage", desc: "Platforms monopolize value; creators and prompters get nothing.", badge: "Value Gap" }
                ]
            },
            thesis: {
                label: "HOLO STUDIO Thesis",
                main: "Creativity is abundant. Trust is scarce.\nWe provide the absolute infrastructure for:\nSafety. Provenance. Value Routing.",
