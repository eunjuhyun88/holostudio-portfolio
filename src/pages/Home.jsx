...
export default function Home() {
    ...
    const content = {
        en: {
            ...
            whatWeDo: {
                title: "What We Do",
                sub: "As AI-generated content becomes the default, trust becomes the bottleneck.",
                problems: [
            ...
            proof: {
                ...
                metrics: {
                    ...
                    eu: { val: "<10ms", label: "Real-time verification latency" },
                    size: { val: "98.9%", label: "ROC AUC" },
                    gap: { val: "100%", label: "GARM brand safety accuracy" }
                }
            },
            opportunity: {
                title: "Why Now",
            ...
            regulatory: {
                ...
                date: "August 2026",
                desc: "EU AI Act enforcement begins. Fines up to 7% of global revenue.",
                warning: "18 months. That's the window."
            },
            cost: {
                title: "The Cost of Inaction",
                sub: "Without trust infrastructure, everyone loses.",
                items: [
                    ...
                    { label: "Platforms", desc: "Face existential legal and regulatory risk" },
                    { label: "Creators", desc: "Lose ownership in an ocean of unverifiable AI content" },
                    { label: "Markets", desc: "Cannot route value without provenance" }
                ],
            ...
            thesis: {
                label: "OUR THESIS",
                pre: "Creativity is abundant.",
                main: "Trust is scarce.",
                post: "When AI becomes an economic actor, trust becomes infrastructure.",
                sub: "HOLO STUDIO builds that infrastructure through three core primitives:",
                keywords: ["Safety – what is allowed", "Provenance – who created it", "Value Routing – who gets paid"]
            },
            business_intro: {
                title: "Products",
                sub: "One Trust Layer. Four Engines."
            },
            milestones: {
                title: "Validation",
            ...
            roadmap: {
                title: "Roadmap",
                sub: "From foundation to standard.",
        ...
        ko: {
            ...
            whatWeDo: {
                title: "우리가 하는 일",
                sub: "AI 생성 콘텐츠가 기본이 되면서, 신뢰가 병목이 됩니다.",
                problems: [
            ...
            proof: {
                ...
                metrics: {
                    ...
                    eu: { val: "<10ms", label: "실시간 검증 지연 시간" },
                    size: { val: "98.9%", label: "ROC AUC" },
                    gap: { val: "100%", label: "GARM 브랜드 안전 정확도" }
                }
            },
            opportunity: {
                title: "왜 지금인가",
            ...
            regulatory: {
                title: "규제 압박",
                date: "2026년 8월",
                desc: "EU AI Act 시행 시작. 위반 시 글로벌 매출 7%까지 과징금.",
                warning: "18개월. 그것이 시간입니다."
            },
            cost: {
                title: "무대응의 비용",
                sub: "신뢰 인프라 없이는 모두가 잃습니다.",
                items: [
                    { val: "$330M", desc: "단 하나의 딥페이크 CFO 화상 통화로 손실" },
                    { val: "68%", desc: "불안전한 광고 게재 후 브랜드를 영구히 불신하는 소비자" },
                    { label: "플랫폼", desc: "존재적 법적, 규제적 리스크 직면" },
                    { label: "창작자", desc: "검증 불가능한 AI 콘텐츠의 바다에서 소유권 상실" },
                    { label: "시장", desc: "출처 없이는 가치를 전달할 수 없음" }
                ],
                conclusion: "신뢰 없는 AI는 확장되지 않습니다. 붕괴합니다."
            },
            ...
            thesis: {
                ...
                pre: "창의성은 풍부합니다.",
                main: "신뢰는 희소합니다.",
                post: "AI가 경제적 행위자가 될 때, 신뢰는 인프라가 됩니다.",
                sub: "HOLO STUDIO는 세 가지 핵심 기본 요소를 통해 그 인프라를 구축합니다:",
                keywords: ["안전 – 무엇이 허용되는가", "출처 – 누가 만들었는가", "가치 라우팅 – 누가 보상받는가"]
            },
            business_intro: {
                title: "프로덕트",
                sub: "하나의 신뢰 레이어. 네 개의 엔진."
            },
            milestones: {
                title: "검증",
                sub: "입증된 트랙션. 업계 검증.",
                        ...
                        <div className={`max-w-2xl mx-auto mb-10 md:mb-12 pt-8 md:pt-10 border-t ${
                            ...
                            <div className="grid md:grid-cols-3 gap-3 md:gap-4 mb-4 md:mb-6">
                                {t.cost.items.slice(2).map((item, idx) => (
                                    ...
                                    >
                                        <h5 className={`text-sm md:text-base font-bold mb-1.5 ${
                                            theme === 'dark' ? 'text-white' : 'text-neutral-900'
                                        }`}>{item.label}</h5>
                                        <p className={`text-xs leading-relaxed ${
                                            theme === 'dark' ? 'text-neutral-300' : 'text-neutral-600'
