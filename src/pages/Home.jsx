    ...
    const content = {
        en: {
            hero: {
                ...
                title: "HOLO STUDIO",
                sub: "In the AI era, content is infinite, but trust is scarce. We build trust as infrastructure.",
                desc: "AI has driven content creation costs to zero. Everyone is a storyteller. Yet we ask: Is it safe? Who made it? Where does the value go?",
                cta1: "View Business Portfolio",
                cta2: "Partnership Inquiry"
            },
            market: {
                year: { val: "2025", label: "AI Reg/Safety Tipping Point" },
                eu: { val: "EU Act", label: "DSA & AI Act Enforced" },
                size: { val: "$80B", label: "AI Content Market (2030)" },
                gap: { val: "$13B+", label: "Gaming/3D Safety Gap" }
            },
            problem: {
                title: "The Core Problem",
                sub: "\"The 'slop' generated by AI is breeding too much distrust.\" — Steve Hirsch\nAI has made everyone a storyteller. But \"trusted\" storytellers remain scarce.",
                cards: [
                    { title: "Safety Crisis", desc: "Deepfakes and toxic content threaten brands and platforms.", badge: "Safety Void" },
                    { title: "Provenance Void", desc: "No way to prove the real creator of AI content.", badge: "No Proof" },
                    { title: "Value Leakage", desc: "Platforms monopolize value even when content goes viral.", badge: "Value Gap" }
                ]
            },
            thesis: {
                label: "HOLO STUDIO Thesis",
                main: "Creativity is no longer the scarce resource. Trust is.\nFaced with AI content, we ask three questions:\nIs it safe? Who made it? Where does the value go?",
            ...
            milestones: {
                ...
                items: [
                    ...
                    { title: "Google Cloud Partner", desc: "Ecosystem Selected" },
            ...
            roadmap: {
                ...
                items: [
                    ...
                    { 
                        ...
                        date: "Q2 2026", 
                        status: "future",
                        desc: "AI-native PvP strategy game with provenance.",
        ...
        ko: {
            ...
            problem: {
                title: "해결하려는 핵심 문제",
                sub: "\"AI가 만들어내는 'slop'들이 너무 많은 불신을 낳고 있습니다.\" — Steve Hirsch\nAI는 모든 사람을 스토리텔러로 만들었습니다. 하지만 \"신뢰받는\" 스토리텔러는 여전히 희소합니다.",
                cards: [
                    { title: "안전의 부재", desc: "딥페이크, 유해 콘텐츠가 브랜드와 플랫폼을 위협합니다.", badge: "AI 리스크" },
                    { title: "출처의 소멸", desc: "AI 콘텐츠의 진짜 창작자가 누구인지 증명할 방법이 없습니다.", badge: "출처 불명" },
                    { title: "가치의 유출", desc: "바이럴이 되어도 창작자가 아닌 플랫폼이 가치를 독점합니다.", badge: "가치 독점" }
                ]
            },
            thesis: {
                label: "HOLO STUDIO Thesis",
                main: "더 이상 희소한 자원은 창의성이 아닙니다. 바로 신뢰입니다.\nAI 콘텐츠 앞에서 우리는 세 가지 질문을 합니다:\n안전한가? 누가 만들었는가? 가치는 어디로 가는가?",
