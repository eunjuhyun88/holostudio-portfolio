                ...
                <div className="grid grid-cols-1 md:grid-cols-2 max-w-[1600px] mx-auto">
                    {products.map((product, index) => (
                        <Link 
                            ...
                            className={`group relative min-h-[500px] md:min-h-[600px] p-8 md:p-16 flex flex-col justify-between overflow-hidden transition-all duration-500 border border-white/5 hover:border-white/10 ${product.theme}`}
                        >
