...
export default function ScrollMotionBackground({ theme = 'dark' }) {
    ...
    const opacity1 = useTransform(scrollYProgress, [0, 0.3, 0.7, 1], 
        theme === 'dark' ? [0.5, 0.7, 0.5, 0.4] : [0.3, 0.5, 0.3, 0.15]
    );
    const opacity2 = useTransform(scrollYProgress, [0, 0.4, 0.8, 1], 
        theme === 'dark' ? [0.4, 0.6, 0.5, 0.6] : [0.15, 0.4, 0.2, 0.5]
    );
        ...
        <div ref={ref} className="fixed inset-0 z-0 pointer-events-none overflow-hidden">
            ...
            <motion.div 
                ...
                className={`absolute top-[10%] left-[5%] w-96 h-96 rounded-full blur-[120px] ${
                    theme === 'dark' 
                        ? 'bg-gradient-to-br from-indigo-500/40 via-purple-500/28 to-transparent'
                        : 'bg-gradient-to-br from-indigo-300/40 via-purple-300/25 to-transparent'
                }`}
            />
            <motion.div 
                style={{ 
                ...
                className={`absolute top-[30%] right-[10%] w-[500px] h-[500px] rounded-full blur-[130px] ${
                    theme === 'dark'
                        ? 'bg-gradient-to-br from-purple-500/32 via-pink-500/24 to-transparent'
                        : 'bg-gradient-to-br from-purple-300/30 via-pink-300/20 to-transparent'
                }`}
            />
            <motion.div 
                style={{ 
                ...
                className={`absolute bottom-[20%] left-[15%] w-[450px] h-[450px] rounded-full blur-[110px] ${
                    theme === 'dark'
                        ? 'bg-gradient-to-br from-blue-500/28 via-indigo-500/32 to-transparent'
                        : 'bg-gradient-to-br from-blue-300/25 via-indigo-300/30 to-transparent'
                }`}
            />
            <motion.div 
                style={{ 
                    y: y4,
                    opacity: useTransform(scrollYProgress, [0, 0.5, 1], theme === 'dark' ? [0.5, 0.65, 0.5] : [0.25, 0.45, 0.25])
                }}
                className={`absolute top-[60%] right-[5%] w-[350px] h-[350px] rounded-full blur-[100px] ${
                    theme === 'dark'
                        ? 'bg-gradient-to-br from-orange-500/24 via-yellow-500/16 to-transparent'
                        : 'bg-gradient-to-br from-orange-300/20 via-yellow-300/15 to-transparent'
                }`}
            />
            ...
            <motion.div
                style={{
                    ...
                    opacity: useTransform(scrollYProgress, [0, 0.3, 0.7, 1], theme === 'dark' ? [0, 0.18, 0.18, 0] : [0, 0.12, 0.12, 0])
                }}
                className={`absolute top-[40%] left-[30%] w-32 h-32 border-2 rounded-2xl ${
                    theme === 'dark' ? 'border-indigo-400/45' : 'border-indigo-400/40'
                }`}
            />
            <motion.div
                style={{
                    ...
                    opacity: useTransform(scrollYProgress, [0, 0.4, 0.8, 1], theme === 'dark' ? [0, 0.15, 0.15, 0] : [0, 0.1, 0.1, 0])
                }}
                className={`absolute top-[70%] right-[25%] w-24 h-24 border-2 rounded-xl ${
                    theme === 'dark' ? 'border-purple-400/38' : 'border-purple-400/35'
                }`}
            />
            ...
            <motion.div 
                style={{ 
                    ...
                    opacity: useTransform(scrollYProgress, [0, 0.3, 0.7, 1], theme === 'dark' ? [0.08, 0.12, 0.12, 0.08] : [0.06, 0.1, 0.1, 0.06])
                }}
                className={`absolute inset-0 bg-[size:100px_100px] ${
                    theme === 'dark'
                        ? 'bg-[linear-gradient(rgba(99,102,241,0.11)_1px,transparent_1px),linear-gradient(90deg,rgba(99,102,241,0.11)_1px,transparent_1px)]'
            ...
            <motion.div 
                style={{ 
                    ...
                    opacity: useTransform(scrollYProgress, [0, 0.3, 0.7, 1], theme === 'dark' ? [0.06, 0.09, 0.09, 0.06] : [0.04, 0.07, 0.07, 0.04])
                }}
                className={`absolute inset-0 bg-[size:60px_60px] ${
                    theme === 'dark'
                        ? 'bg-[linear-gradient(rgba(168,85,247,0.09)_1px,transparent_1px),linear-gradient(90deg,rgba(168,85,247,0.09)_1px,transparent_1px)]'
            ...
            <motion.div
                ...
                className={`absolute left-0 right-0 h-[300px] bg-gradient-to-b from-transparent to-transparent blur-sm ${
                    theme === 'dark' ? 'via-indigo-400/55' : 'via-indigo-500/50'
                }`}
            />

            {/* Animated corner decorations with pulse */}
            <motion.div 
                animate={{ opacity: theme === 'dark' ? [0.4, 0.65, 0.4] : [0.3, 0.5, 0.3] }}
                transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }}
                className={`absolute top-0 left-0 w-40 h-40 border-l-2 border-t-2 rounded-tl-3xl m-8 ${
                    theme === 'dark' ? 'border-indigo-400/50' : 'border-indigo-400/40'
                }`}
            />
            <motion.div 
                animate={{ opacity: theme === 'dark' ? [0.4, 0.65, 0.4] : [0.3, 0.5, 0.3] }}
                ...
                className={`absolute top-0 right-0 w-40 h-40 border-r-2 border-t-2 rounded-tr-3xl m-8 ${
                    theme === 'dark' ? 'border-purple-400/50' : 'border-purple-400/40'
                }`}
            />
            <motion.div 
                animate={{ opacity: theme === 'dark' ? [0.4, 0.65, 0.4] : [0.3, 0.5, 0.3] }}
                ...
                className={`absolute bottom-0 left-0 w-40 h-40 border-l-2 border-b-2 rounded-bl-3xl m-8 ${
                    theme === 'dark' ? 'border-blue-400/50' : 'border-blue-400/40'
                }`}
            />
            <motion.div 
                animate={{ opacity: theme === 'dark' ? [0.4, 0.65, 0.4] : [0.3, 0.5, 0.3] }}
                ...
                className={`absolute bottom-0 right-0 w-40 h-40 border-r-2 border-b-2 rounded-br-3xl m-8 ${
                    theme === 'dark' ? 'border-pink-400/50' : 'border-pink-400/40'
                }`}
            />
            ...
            {[...Array(8)].map((_, i) => (
                <motion.div
                    ...
                    style={{
                        ...
                        opacity: useTransform(scrollYProgress, [0, 0.5, 1], theme === 'dark' ? [0, 0.3, 0] : [0, 0.2, 0])
                    }}
                    className={`absolute w-1 h-1 rounded-full blur-[0.5px] ${
                        theme === 'dark' ? 'bg-indigo-400/55' : 'bg-indigo-500/50'
                    }`}
                    initial={{
                        top: `${Math.random() * 100}%`,
